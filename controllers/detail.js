...
exports.getDetailContent = async function(req,res){
    ...
    for (let i = 0; i < skenario.length; i++) {
        ...
        jsonres.push({
            ...
            totalNewNormal: Math.round(skenario[i].Total_New_Normal_KONDISI_1 * 100) / 100,
            totalPengelolaAgunan: Math.round(skenario[i].Total_Pengelola_Agunan_KONDISI_1 * 100) / 100,
